...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, arc=.35mm, colback=white, opacityback=0, toptitle=1mm, bottomrule=.15mm, toprule=.15mm, titlerule=0mm, opacitybacktitle=0.6, colframe=quarto-callout-important-color-frame, breakable, colbacktitle=quarto-callout-important-color!10!white, title={Resposta (b)}, leftrule=.75mm, bottomtitle=1mm, rightrule=.15mm, coltitle=black]
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, arc=.35mm, colback=white, opacityback=0, toptitle=1mm, bottomrule=.15mm, toprule=.15mm, titlerule=0mm, opacitybacktitle=0.6, colframe=quarto-callout-important-color-frame, breakable, colbacktitle=quarto-callout-important-color!10!white, title={Resposta (c)}, leftrule=.75mm, bottomtitle=1mm, rightrule=.15mm, coltitle=black]
